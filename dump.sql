...
--
-- Name: employees; Type: TABLE; Schema: public; Owner: name
--
...
ALTER TABLE public.employees OWNER TO name;

--
-- Data for Name: employees; Type: TABLE DATA; Schema: public; Owner: name
--
